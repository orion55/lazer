...
<a class="skip-link screen-reader-text"
   href="#content"><?php esc_html_e('Skip to content', 'llorix-one-lite'); ?></a>
<!-- =========================
	PRE LOADER
============================== -->
<?php
...
<header itemscope itemtype="http://schema.org/WPHeader" id="masthead" role="banner"
        ...
        class="header header-style-one site-header<?php echo $parallax_effect; ?>">
        ...
        <div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation appear-on-scroll">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <button title='<?php _e('Toggle Menu', 'llorix-one-lite'); ?>'
                            aria-controls='menu-main-menu' aria-expanded='false' type="button"
                            class="navbar-toggle menu-toggle" id="menu-toggle"
                ...
                <div itemscope itemtype="http://schema.org/SiteNavigationElement"
                     aria-label="<?php esc_html_e('Primary Menu', 'llorix-one-lite'); ?>"
                     id="menu-primary" class="navbar-collapse collapse">
